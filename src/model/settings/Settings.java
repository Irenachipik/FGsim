...
public class Settings {
    ...
    private static final String FLIGHT_GEAR_Host = "FlightGearHost";
    ...
    public static Settings fromDoc(Document doc) {
        ...
        settings.setFlightGearHost(doc.getElementsByTagName(FLIGHT_GEAR_Host).item(0).getTextContent().trim());
        return settings;
    }

    private void setFlightGearHost(String host) { simulatorHost=host;}
